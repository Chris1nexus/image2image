...
from im2im.models.architecture.cyclegan import GeneratorResNet, Discriminator
from im2im.models.architecture.cyclegan import weights_init_normal

from im2im.models.utils import ReplayBuffer, LambdaLR
...
def parse_args(args=None):
    ...
    parser.add_argument("--source_dataset_name", type=str, default="Chris1/GTA5", help="name of the source dataset")
    parser.add_argument("--target_dataset_name", type=str, default="Chris1/cityscapes", help="name of the target dataset")
